/**
 * Main entrypoint for DeepCLI Agent SDK types.
 *
 ...
 *
 * If your SDK MCP calls will run longer than 60s, override DEEPCLI_STREAM_CLOSE_TIMEOUT
 */
...
/**
 * A scheduled task from `<dir>/.deepcli/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.deepcli/scheduled_tasks.json` and yield events as tasks fire.
 *
