 ...
 *
 * Used by both `deepcli remote-control` (empty session so the user has somewhere to
 ...
 * explicit client action. Both `deepcli remote-control` (standalone bridge) and the
