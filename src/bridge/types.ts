...
/** Full error printed when `deepcli remote-control` is run without auth. */
...
export type WorkSecret = {
  ...
  deepcli_code_args?: Record<string, string> | null
...
/**
 * How `deepcli remote-control` chooses session working directories.
 ...
 */
export type BridgeWorkerType = 'deepcli_code' | 'deepcli_code_assistant'
...
export type BridgeConfig = {
   ...
   * instead of creating a new one. Used by `deepcli remote-control
