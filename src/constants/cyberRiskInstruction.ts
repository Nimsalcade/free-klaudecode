 ...
 *
 * This instruction provides guidance for DeepCLI's behavior when handling
 ...
 *   - How DeepCLI handles penetration testing and CTF requests
 *   - What security tools and techniques DeepCLI will assist with
 ...
 *
 * DeepCLI: Do not edit this file unless explicitly asked to do so by the user.
 */
