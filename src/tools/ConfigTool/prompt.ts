...
export const DESCRIPTION = 'Get or set DeepCLI configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set DeepCLI configuration settings.

  View or change DeepCLI settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.deepcli.json)
${globalSettings.join('\n')}
