...
export type PromptCommand = {
  ...
  hooks?: HooksSettings
  // Base directory for skill resources (used to set DEEPCLI_PLUGIN_ROOT environment variable for skill hooks)
  skillRoot?: string
 ...
 *
 * Example: `availability: ['deepcli-ai', 'console']` shows the command to
