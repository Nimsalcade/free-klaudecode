...
//   protoc               unknown
// source: events_mono/deepcli_code/v1/deepcli_code_internal_event.proto
 ...
 * See deepcli-cli-internal/src/services/statsig.ts for the source of these fields
 */
export interface EnvironmentMetadata {
  ...
  is_deepcli_code_action?: boolean | undefined
  ...
  is_deepcli_code_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  deepcli_code_container_id?: string | undefined
  deepcli_code_remote_session_id?: string | undefined
...
/**
 * SlackContext contains context fields present on every DeepCLI-in-Slack (CIS) event.
...
/**
 * ClaudeCodeInternalEvent represents events logged from DeepCLI via Statsig
 * This schema matches the structure in deepcli-cli-internal/src/services/statsig.ts
...
export interface ClaudeCodeInternalEvent {
  ...
  /** DeepCLI-in-Slack context (only present for cis_* events) */
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    arch: '',
    is_deepcli_code_remote: false,
    remote_environment_type: '',
    deepcli_code_container_id: '',
    deepcli_code_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_deepcli_code_action: isSet(object.is_deepcli_code_action)
        ? globalThis.Boolean(object.is_deepcli_code_action)
        : false,
      ...
      is_deepcli_code_remote: isSet(object.is_deepcli_code_remote)
        ? globalThis.Boolean(object.is_deepcli_code_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      deepcli_code_container_id: isSet(object.deepcli_code_container_id)
        ? globalThis.String(object.deepcli_code_container_id)
        : '',
      deepcli_code_remote_session_id: isSet(object.deepcli_code_remote_session_id)
        ? globalThis.String(object.deepcli_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_deepcli_code_action !== undefined) {
      obj.is_deepcli_code_action = message.is_deepcli_code_action
    }
    ...
    if (message.is_deepcli_code_remote !== undefined) {
      obj.is_deepcli_code_remote = message.is_deepcli_code_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.deepcli_code_container_id !== undefined) {
      obj.deepcli_code_container_id = message.deepcli_code_container_id
    }
    if (message.deepcli_code_remote_session_id !== undefined) {
      obj.deepcli_code_remote_session_id = message.deepcli_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_deepcli_code_action = object.is_deepcli_code_action ?? false
    ...
    message.is_deepcli_code_remote = object.is_deepcli_code_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.deepcli_code_container_id = object.deepcli_code_container_id ?? ''
    message.deepcli_code_remote_session_id =
      object.deepcli_code_remote_session_id ?? ''
