...
/**
 * Loads markdown files from .deepcli/output-styles directories throughout the project
 * and from ~/.deepcli/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .deepcli/output-styles/*.md -> project styles
 * - User ~/.deepcli/output-styles/*.md -> user styles (overridden by project styles)
 *
