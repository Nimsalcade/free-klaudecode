...
export function CostThresholdDialog(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = <Box flexDirection="column"><Text>Learn more about how to monitor your spending:</Text><Link url="https://docs.deepcli.dev/docs/en/costs" /></Box>;
    $[0] = t1;
  } else {
    t1 = $[0];
  }
  ...
  let t4;
  if ($[4] !== onDone || $[5] !== t3) {
    t4 = <Dialog title="You've spent $5 on the NexusAI API this session." onCancel={onDone}>{t1}{t3}</Dialog>;
    $[4] = onDone;
    $[5] = t3;
    $[6] = t4;
  } else {
