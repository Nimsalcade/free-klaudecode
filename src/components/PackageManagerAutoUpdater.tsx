...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateCommand = packageManager === "homebrew" ? "brew upgrade deepcli-code" : packageManager === "winget" ? "winget upgrade NexusAI.ClaudeCode" : packageManager === "apk" ? "apk upgrade deepcli-code" : "your package manager update command";
  let t4;
  if ($[3] !== verbose) {
