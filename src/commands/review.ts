...
// user triggers, so the description carries "DeepCLI on the web" + URL.
const CCR_TERMS_URL = 'https://docs.deepcli.dev/docs/en/deepcli-cloud'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in DeepCLI Cloud. See ${CCR_TERMS_URL}`,
