 ...
 * - Process-based teammates use their DEEPCLI_AGENT_NAME
...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for DeepCLI (include color if available)
    // Transform plan approval requests to include instructions for DeepCLI
