...
const NPM_DEPRECATION_MESSAGE = 'DeepCLI has switched from npm to native installer. Run `deepcli install` or see https://docs.nexusai.com/en/docs/deepcli-code/getting-started for more options.';
