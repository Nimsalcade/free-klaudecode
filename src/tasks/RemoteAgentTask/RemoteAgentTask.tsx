...
export function formatPreconditionError(error: BackgroundRemoteSessionPrecondition): string {
  switch (error.type) {
    ...
    case 'github_app_not_installed':
      return 'The DeepCLI GitHub app must be installed on this repository first.\nhttps://github.com/apps/deepcli/installations/new';
    case 'policy_blocked':
 ...
 *   {type:'system', subtype:'hook_progress', stdout:'...'}. DeepCLI never
...
function startRemoteSessionPolling(taskId: string, context: TaskContext): () => void {
  ...
  const poll = async (): Promise<void> => {
    ...
    try {
      ...
      // stableIdle is a prompt-mode completion signal (DeepCLI stops writing
