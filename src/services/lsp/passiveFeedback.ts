...
/**
 * Map LSP severity to DeepCLI diagnostic severity
 *
 * Maps LSP severity numbers to DeepCLI diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to DeepCLI diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by DeepCLI's attachment system.
 */
 ...
 * from all LSP servers and routes them to DeepCLI's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to DeepCLI format (can throw on invalid URIs)
