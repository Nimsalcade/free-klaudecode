...
/**
 * Official MCP registry fetch is disabled — no connections to
 * api.anthropic.com permitted. isOfficialMcpUrl always returns false.
 */
export async function prefetchOfficialMcpUrls(): Promise<void> {
  // No-op: the Anthropic MCP registry endpoint is not reachable.
}
