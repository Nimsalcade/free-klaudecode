...
import { DEEPCLI_AI_INFERENCE_SCOPE } from '../../constants/oauth.js'
import {
 ...
 *   DEEPCLI_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Externally-injected tokens (CCD via DEEPCLI_OAUTH_TOKEN, CCR via
  // DEEPCLI_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
