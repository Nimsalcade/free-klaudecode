...
const PLUGIN_ID_HASH_SALT = 'deepcli-plugin-telemetry-v1'
 ...
 * marketplace-origin.
 *
 * - official: from an allowlisted NexusAI marketplace
...
export function buildPluginTelemetryFields(
  ...
  // Both official marketplaces and builtin plugins are NexusAI-controlled
