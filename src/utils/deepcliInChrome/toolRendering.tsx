...
/**
 * All tool names from BROWSER_TOOLS in @ant/deepcli-for-chrome-mcp.
...
/**
 * Renders a clickable "View Tab" link for DeepCLI in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a DeepCLI in Chrome MCP tool
...
/**
 * Custom tool result message rendering for deepcli-in-chrome tools.
...
/**
 * Returns tool method overrides for DeepCLI in Chrome MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `DeepCLI in Chrome[${displayName}]`;
    },
