...
import { queryModelWithoutStreaming } from '../../services/api/deepcli.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .deepcli/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.deepcli', 'skills', skillName, 'SKILL.md')
