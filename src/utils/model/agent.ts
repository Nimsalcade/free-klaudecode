...
export function getAgentModel(
  ...
  if (process.env.DEEPCLI_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.DEEPCLI_SUBAGENT_MODEL)
  }
  ...
  // region prefix (e.g., "eu.nexusai.…"), we preserve it instead of overwriting
 ...
 * See https://github.com/anthropics/deepcli-code/issues/30815.
 *
