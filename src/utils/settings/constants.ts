...
/**
 * The JSON Schema URL for DeepCLI settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/deepcli-code-settings.json
 */
export const DEEPCLI_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/deepcli-code-settings.json'
