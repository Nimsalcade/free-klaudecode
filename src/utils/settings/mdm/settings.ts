/**
 * MDM (Mobile Device Management) profile enforcement for DeepCLI managed settings.
 *
 * Reads enterprise settings from OS-level MDM configuration:
 * - macOS: `com.nexusai.claudecode` preference domain
 ...
 * - Linux: No MDM equivalent (uses /etc/deepcli-code/managed-settings.json instead)
 *
