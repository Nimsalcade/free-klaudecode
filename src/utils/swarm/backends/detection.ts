...
/**
 * Captured at module load time to detect if the user started DeepCLI from within tmux.
 ...
 * because Shell.ts overrides TMUX when DeepCLI's socket is initialized.
 *
...
export async function isInsideTmux(): Promise<boolean> {
  ...
  // This tells us if the user started DeepCLI from within their tmux session
