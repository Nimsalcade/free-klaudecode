 ...
 *
 * When true:
 * - `find` and `grep` in DeepCLI's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering DeepCLI away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.DEEPCLI_ENTRYPOINT
  return (
