 ...
 * variables instead: DEEPCLI_AGENT_ID, DEEPCLI_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from DEEPCLI_PARENT_SESSION_ID env var), undefined for main REPL subagents */
