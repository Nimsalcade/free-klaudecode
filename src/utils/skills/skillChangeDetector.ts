...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.deepcli/skills)
  ...
  // User commands directory (~/.deepcli/commands)
  ...
  // Project skills directory (.deepcli/skills)
  ...
  // Project commands directory (.deepcli/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.deepcli', 'skills')
    try {
