 ...
 *
 * These helpers identify whether this DeepCLI instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.DEEPCLI_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our DEEPCLI_AGENT_ID matches the leadAgentId, OR
 *    - We have no DEEPCLI_AGENT_ID set (backwards compat: the original
