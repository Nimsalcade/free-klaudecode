 ...
 *
 * Each teammate has an inbox file at .deepcli/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.deepcli/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to DEEPCLI_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's DEEPCLI_AGENT_ID */
  workerId: string
  /** Worker's DEEPCLI_AGENT_NAME */
  workerName: string
  /** Worker's DEEPCLI_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to DEEPCLI_TEAM_NAME env var)
