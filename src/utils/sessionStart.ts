  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.deepcli/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .deepcli/settings.json'
      } else {
        userGuidance =
      ...
      // from .deepcli/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
