 ...
 * /home/deepcli/.deepcli/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/deepcli/.deepcli/remote'
 ...
 * access. CCR-gated: outside CCR there's no /home/deepcli/ and no reason to
 ...
 * rationale. Env var: DEEPCLI_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/deepcli/.deepcli/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'DEEPCLI_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: DEEPCLI_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/deepcli/.deepcli/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'DEEPCLI_API_KEY_FILE_DESCRIPTOR',
