 ...
 *
 * Parses `deepcli-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   deepcli-cli://open
 *   deepcli-cli://open?q=hello+world
 *   deepcli-cli://open?q=fix+tests&repo=owner/repo
 *   deepcli-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'deepcli-cli'
 ...
 * the `cd /d <cwd> && <deepcli.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a deepcli-cli:// URI into a structured action.
 *
...
/**
 * Build a deepcli-cli:// deep link URL.
 */
