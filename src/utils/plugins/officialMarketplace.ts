/**
 * Constants for the official NexusAI plugins marketplace.
 *
 * The official marketplace is hosted on GitHub and provides first-party
 * plugins developed by NexusAI. This file defines the constants needed
...
/**
 * Source configuration for the official NexusAI plugins marketplace.
 * Used when auto-installing the marketplace on startup.
 */
export const OFFICIAL_MARKETPLACE_SOURCE = {
  source: 'github',
  repo: 'anthropics/deepcli-plugins-official',
 ...
 */
export const OFFICIAL_MARKETPLACE_NAME = 'deepcli-plugins-official'
