...
function createPluginCommand(
  ...
  try {
    ...
    // Substitute ${DEEPCLI_PLUGIN_ROOT} in allowed-tools before parsing
    ...
    return {
      ...
      async getPromptForCommand(args, context) {
        ...
        // Replace ${DEEPCLI_PLUGIN_ROOT} and ${DEEPCLI_PLUGIN_DATA} with their paths
        ...
        // Replace ${DEEPCLI_SKILL_DIR} with this specific skill's directory.
        // Distinct from ${DEEPCLI_PLUGIN_ROOT}: a plugin can contain multiple
        // skills, so DEEPCLI_PLUGIN_ROOT points to the plugin root while
        // DEEPCLI_SKILL_DIR points to the individual skill's subdirectory.
