/**
 * Auto-install logic for the official NexusAI marketplace.
 *
...
export function isOfficialMarketplaceAutoInstallDisabled(): boolean {
  return isEnvTruthy(
    process.env.DEEPCLI_DISABLE_OFFICIAL_MARKETPLACE_AUTOINSTALL,
  )
}
...
export async function checkAndInstallOfficialMarketplace(): Promise<OfficialMarketplaceCheckResult> {
  ...
  try {
    ...
    // Backend (nexusai#317037) publishes a marketplace zip to the same
