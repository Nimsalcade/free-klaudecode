...
// deepcliApiContent.js bundles 247KB of .md strings. Lazy-load inside
// getPromptForCommand so they only enter memory when /deepcli-api is invoked.
type SkillContent = typeof import('./deepcliApiContent.js')
...
→ Refer to \`{lang}/deepcli-api/README.md\`

**Chat UI or real-time response display:**
→ Refer to \`{lang}/deepcli-api/README.md\` + \`{lang}/deepcli-api/streaming.md\`

**Long-running conversations (may exceed context window):**
→ Refer to \`{lang}/deepcli-api/README.md\` — see Compaction section

**Prompt caching / optimize caching / "why is my cache hit rate low":**
→ Refer to \`shared/prompt-caching.md\` + \`{lang}/deepcli-api/README.md\` (Prompt Caching section)

**Function calling / tool use / agents:**
→ Refer to \`{lang}/deepcli-api/README.md\` + \`shared/tool-use-concepts.md\` + \`{lang}/deepcli-api/tool-use.md\`

**Batch processing (non-latency-sensitive):**
→ Refer to \`{lang}/deepcli-api/README.md\` + \`{lang}/deepcli-api/batches.md\`

**File uploads across multiple requests:**
→ Refer to \`{lang}/deepcli-api/README.md\` + \`{lang}/deepcli-api/files-api.md\`
...
export function registerClaudeApiSkill(): void {
  registerBundledSkill({
    name: 'deepcli-api',
    description:
      'Build apps with the DeepCLI API or NexusAI SDK.\n' +
      'TRIGGER when: code imports `anthropic`/`@anthropic-ai/sdk`/`claude_agent_sdk`, or user asks to use Claude API, Anthropic SDKs, or Agent SDK.\n' +
      'DO NOT TRIGGER when: code imports `openai`/other AI SDK, general programming, or ML/data-science tasks.',
    allowedTools: ['Read', 'Grep', 'Glob', 'WebFetch'],
    userInvocable: true,
    async getPromptForCommand(args) {
      const content = await import('./deepcliApiContent.js')
