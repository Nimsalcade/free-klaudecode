...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`deepcli assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `deepcli assistant`: count of background tasks (Agent calls, teammates,
  ...
  // System Dashboard overlay toggled by 'd' key from LogoV2 view
